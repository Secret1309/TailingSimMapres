        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <main className="container mx-auto max-w-5xl px-4 py-12">
                ...
                <div className="space-y-12">
                    ...
                    {/* Section 5: Physicochemical & Biogeopolymer */}
                    <section className="rounded-2xl border bg-white p-8 shadow-sm">
                        <h2 className="mb-6 text-2xl font-bold text-gray-900">Pengaruh Komposisi Tailing terhadap Produksi Biogeopolimer</h2>
                        <p className="mb-6 text-gray-600">
                            Komposisi fisikokimia tailing secara langsung menentukan strategi produksi biogeopolimer.
                            Perbedaan utama antara kedua jenis tailing yang disimulasikan:
                        </p>
                        <div className="grid gap-6 md:grid-cols-2">
                            <div className="rounded-xl border-2 border-red-200 bg-red-50/40 p-6">
                                ...
                                <p className="text-sm text-gray-700">
                                    Terkontaminasi logam berat (As, Hg) dan sisa sianida (CN⁻). Membutuhkan destruksi sianida dan matriks geopolimer
                                    yang rapat (dibantu biopolimer) untuk enkapsulasi logam berat melalui proses <em>Solidification/Stabilization</em> (S/S).
                                </p>
                            </div>
                            <div className="rounded-xl border-2 border-amber-200 bg-amber-50/40 p-6">
                                ...
                                <p className="text-sm text-gray-700">
                                    Kaya akan mineral sulfida (Pirit/FeS₂) yang berpotensi menghasilkan Air Asam Tambang (AMD).
                                    Membutuhkan aktivasi alkali tinggi untuk netralisasi pirit dan penambahan ko-prekursor karena
                                    reaktivitas aluminosilikat bawaannya yang rendah.
                                </p>
                            </div>
                        </div>
                    </section>
